...
class MetricsLogger:
    def __init__(
            self, iteration, tb_path, output_path,
            train_loader, val_loader, n_classes, n_concepts=None, device=None
    ):
        """
        ...
        if self.n_concepts is not None:
            self.list_attributes_per_epoch = {
                "train_loss_per_concept": np.zeros(n_concepts),
                "val_loss_per_concept": np.zeros(n_concepts),
                "train_feature_importance": np.zeros(n_concepts),
                "val_feature_importance": np.zeros(n_concepts),
            }
        else:
            self.list_attributes_per_epoch = {}
    ...
    def track_selectivenet_stats(self):
        ...
        # self.tb.add_scalar("Train_Pi_stats/N_Selected", self.attributes_per_epoch["train_n_selected"],
        #                    self.epoch_id)
        # self.tb.add_scalar("Train_Pi_stats/N_Rejected", self.attributes_per_epoch["train_n_rejected"],
        #                    self.epoch_id)
        # self.tb.add_scalar("Train_Pi_stats/coverage", self.attributes_per_epoch["train_coverage"],
        #                    self.epoch_id)
